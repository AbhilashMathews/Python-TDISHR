...
for _item in _data.__dict__.keys():
  try:
    if issubclass(_data.__dict__[_item],_data.Data):
        globals()[_item]=_data.__dict__[_item]
  except:
    pass
_tree=_mimport('tree',2)
for _item in _tree.__dict__.keys():
  try:
    if issubclass(_tree.__dict__[_item],_data.Data):
        globals()[_item]=_tree.__dict__[_item]
  except:
    pass
...
class dataTests(TestCase):
    ...
    def tdiFunctions(self):
        ...
        """Test Array"""
        doUnaryArray('zero(10)*0',Float32Array([range(10)])*0.0)
        doUnaryArray('zero(10,0)*0',Int32Array([range(10)])*0)
        doUnaryArray('zero(10,0BU)*0BU',Uint8Array([range(10)])*Uint8(0))
        """Test ASIN"""
